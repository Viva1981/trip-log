    ...
    <main className="space-y-4">
      ...
      <Card title="Utazás adatai" subtitle="Bejelentkezve a tulajdonosi név és email is mentésre kerül.">
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <Select label="Láthatóság" name="visibility" value={form.visibility} onChange={onChange}
            options={[ { value: "public", label: "Publikus" }, { value: "private", label: "Privát" } ]} />
          <label className="block text-sm space-y-1">
            <span className="text-gray-700">Útitársak (e-mail, vesszővel elválasztva)</span>
            <textarea name="companions" value={form.companions} onChange={onChange} rows={3}
